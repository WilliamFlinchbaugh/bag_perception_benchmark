# from https://github.com/google-research-datasets/Objectron/blob/master/objectron/dataset/iou.py
...
import benchmark_tools.box as Box
...
class IoU(object):
    ...
    def _compute_intersection_points(self, box_src, box_template):
        ...
        try:
            ...
            inv_transform = np.linalg.pinv(box_src.transformation)
